...
public:
	...
	static inline unsigned int ValueOfHex(const TCHAR ch) {
		if (ch >= '0' && ch <= '9')
			return ch - '0';
		else if (ch >= 'A' && ch <= 'F')
			return ch - 'A' + 10;
...
public:
	...
	virtual void Create(const TCHAR *faceName, int characterSet, int size,
...
public:
	...
	virtual void DrawTextNoClip(PRectangle rc, Font &font_, int ybase, const TCHAR *s, int len, ColourAllocated fore, ColourAllocated back)=0;
	virtual void DrawTextClipped(PRectangle rc, Font &font_, int ybase, const TCHAR *s, int len, ColourAllocated fore, ColourAllocated back)=0;
	virtual void DrawTextTransparent(PRectangle rc, Font &font_, int ybase, const TCHAR *s, int len, ColourAllocated fore)=0;
	virtual void MeasureWidths(Font &font_, const TCHAR *s, int len, int *positions)=0;
	virtual int WidthText(Font &font_, const TCHAR *s, int len)=0;
	virtual int WidthChar(Font &font_, TCHAR ch)=0;
...
public:
	...
	virtual void Append(TCHAR *s, int type = -1)=0;
	virtual int Length()=0;
	virtual void Select(int n)=0;
	virtual int GetSelection()=0;
	virtual int Find(const TCHAR *prefix)=0;
	virtual void GetValue(int n, TCHAR *value, int len)=0;
	virtual void RegisterImage(int type, const char *xpm_data)=0;
	virtual void ClearRegisteredImages()=0;
	virtual void SetDoubleClickAction(CallBackAction, void *)=0;
	virtual void SetList(const TCHAR* list, TCHAR separator, TCHAR typesep)=0;
};
...
public:
	...
	virtual Function FindFunction(const TCHAR *name) = 0;

	/// @return true if the library was loaded successfully.
	virtual bool IsValid() = 0;

	/// @return An instance of a DynamicLibrary subclass with "modulePath" loaded.
	static DynamicLibrary *Load(const TCHAR *modulePath);
};
...
public:
	...
	static const TCHAR *DefaultFont();
	static int DefaultFontSize();
	static unsigned int DoubleClickTime();
	static bool MouseButtonBounce();
	static void DebugDisplay(const TCHAR *s);
	static bool IsKeyDown(int key);
	static long SendScintilla(
		WindowID w, unsigned int msg, unsigned long wParam=0, long lParam=0);
	static long SendScintillaPointer(
		WindowID w, unsigned int msg, unsigned long wParam=0, void *lParam=0);
	static bool IsDBCSLeadByte(int codePage, TCHAR ch);
	static int DBCSCharLength(int codePage, const TCHAR *s);
	...
	static void Assert(const TCHAR *c, const TCHAR *file, int line);
